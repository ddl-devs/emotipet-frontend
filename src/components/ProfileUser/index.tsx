        ...
        <div className="flex relative flex-row">
            <div className={`relative flex flex-col bg-white shadow-lg w-[640px] h-auto justify-center items-center rounded-3xl ${editable ? style.profile : ''}`}>
                ...
                <div className="items-center justify-center flex flex-col relative -top-[70]">
                    ...
                    {editable && (
                    <div className="mt-2">
                        <label className="text-blackGray font-semibold" htmlFor="profileImage">Trocar foto de perfil</label>
                        <input
                            id="profileImage"
                            type="file"
                            accept="image/*"
                    ...
                    <div className=" flex flex-row gap-2">
                        <ProfileInput editable={editable} classNm="font-bold text-2xl" input="Davy" placeholder="Insira um nome" wid="250px" color="orange" id="firstName" />
                        <ProfileInput editable={editable} classNm="font-bold text-2xl" input="Oliveira Teodósio" placeholder="Insira um sobrenome" wid="250px" color="orange" id="lastName" />
                    </div>
                </div>
                ...
                <div className="flex h-auto flex-wrap gap-5 -mt-10 mb-[50px] max-w-[80%] items-start justify-center">
                    <div className="gap-5 flex items-start flex-col">
                        <ProfileInput editable={editable} type="email" id="email" input="teste@gmail.com" label="Email:" placeholder="Insira um email" wid="220px"></ProfileInput>
                        <ProfileInput editable={editable} id="data" input="24/02/2024" label="Data de Nascimento:" placeholder="Insira uma data" wid="220px"></ProfileInput>
                    </div>
                    <div className="flex flex-wrap gap-5 items-start justify-start">
                        <ProfileInput id="username" input="DamiãoPaiDeFamilia" label="Username:" placeholder="Digite uma username" wid="220px"></ProfileInput>
                    </div>
                </div>
            </div>
